...
{
    public class DeleteTransactionCommandHandler : IRequestHandler<DeleteTransactionCommand, TransactionResult>
    {
        private readonly IRabbitMQProducer _producer;

        public DeleteTransactionCommandHandler(IRabbitMQProducer producer)
        {
            _producer = producer;
        }
